                        ...
                        <div class="padding-custom ps-lg-5">
                            ...
                            <div class="d-flex align-items-center gap-4 my-2">
                                ...
                                <p class="m-0 fs-4 fw-regular" style="color: var(--colortext2);">
                                    Quy mô: 
                                    <span class="fs-4 fw-regular" style="color: var(--colortext1); line-height: 2.2rem;">11 sân</span>
                                </p>
                            </div>
                            <div class="d-flex align-items-center gap-4 my-2">
                                ...
                                <p class="m-0 fs-4 fw-regular" style="color: var(--colortext2);">
                                    Mở cửa: 
                                    <span class="fs-4 fw-regular" style="color: var(--colortext1); line-height: 2.2rem;">24/24</span>
                                </p>
                            </div>
                            <div class="d-flex align-items-center gap-4 my-2">
                                ...
                                <p class="m-0 fs-4 fw-regular" style="color: var(--colortext2);">
                                    ...
                                    <span class="fs-4 fw-regular" style="color: var(--colortext1); line-height: 2.2rem;">
                                        Số 238 Đường 3 Tháng 2, Phường 12, Quận 10, TP.HCM.
                                    </span>
                                </p>
                            </div>
                            ...
                            <a href="#" class="d-block btn-find" style="width: 32%; padding: 15px 0 17px 0;">Đặt ngay</a>
                        </div>
                    </div>
                </div>
            </div>
