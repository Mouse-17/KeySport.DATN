            ...
            <div class="banner-box px-3 ">
                <div class="container">
                    ...
                    <div class="d-flex justify-content-center">
                        <p class="text-intro">Hệ thống đặt sân thông minh giúp bạn tìm được sân, đặt sân nhanh chóng với mức giá hợp lí.</p>
                    </div>
                    <div class="d-flex justify-content-center">
                        <form class="custom-form d-flex justify-content-center p-5 p-lg-4">
                            <div class="w-100 row justify-content-center">
                                <div class="col-12 col-lg-3 col-md-12 m-1 m-lg-2 p-2 p-lg-0">
                                    <!-- <div class="custom-select d-flex justify-content-between align-items-center position-relative px-4">
                                        <div id="type-yard">Bộ môn</div>
                                        <i class="bi bi-caret-down-fill"></i>
                                        <ul class="menu pt-4" id="list-yard">
                                            <li>
                                                <input type="hidden" name="bongda" id="bongda">
                                                <label value="bongda" class="option-label" for="bongda" style="border-radius: 12px 12px 0 0;">Sân bóng đá</label>
                                            </li>
                                            <li>
                                                <input type="hidden" name="caulong" id="caulong">
                                                <label class="option-label" for="caulong">Sân cầu lông</label>
                                            </li>
                                            <li>
                                                <input type="hidden" name="tennis" id="tennis">
                                                <label class="option-label" for="tennis">Sân tennis</label>
                                            </li>
                                            <li>
                                                <input type="hidden" name="pickkleball" id="pickkleball">
                                                <label class="option-label" for="pickkleball">Sân pickkleball</label>
                                            </li>
                                            <li>
                                                <input type="hidden" name="bongchuyen" id="bongchuyen">
                                                <label class="option-label" for="bongchuyen">Sân bóng chuyền</label>
                                            </li>
                                            <li>
                                                <input type="hidden" name="bongro" id="bongro">
                                                <label class="option-label" for="bongro" style="border-radius: 0 0 12px 12px;">Sân bóng rổ</label>
                                            </li>
                                        </ul>
                                    </div> -->
                                    <select aria-label="Default select example" class="form-date d-block w-100">
                                ...
                                <div class="col-12 col-lg-3 col-md-12 m-1 m-lg-2 p-2 p-lg-0">
                                    <select aria-label="Default select example" class="form-date d-block w-100">
                                        ...
                                        <option value="6-8"selected>06:00 - 08:00</option>
                                        ...
                                        <option value="22-0">22:00 - 00:00</option>
                                    </select>
                                </div>
                                <div class="col-12 col-lg-3 col-md-12 m-1 m-lg-2 p-2 p-lg-0">
            ...
            <div class="container">
                <div class="custom-intro">
                    <div class="row justify-content-center gx-3 d-none d-lg-flex d-md-flex">
                        <div class="col-2">
                            <img src="../../public/img/loa.png" alt="" class="img-fluid img-loa">
                        </div>
                        <div class="col-8">
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="container-sm row justify-content-center gap-3">
                            <div class="col-12 col-lg-3 col-md-4">
                                <a href="" class="custom-intro-box">
                                    <div class="pt-1 pb-4 text-center">
                                        <img src="../../public/img/booking.png" alt="" style="width: 30%;">
                                    </div>
                            ...
                            <div class="col-12 col-lg-3 col-md-4">
                                <a href="" class="custom-intro-box">
                                    <div class="pt-1 pb-4 text-center">
                                        <img src="../../public/img/giohang.png" alt="" style="width: 30%;">
                                    </div>
                            ...
                            <div class="col-12 col-lg-3 col-md-4">
                                <a href="" class="custom-intro-box">
                                    <div class="pt-1 pb-4 text-center">
                                        <img src="../../public/img/chusan.png" alt="" style="width: 30%;">
                                    </div>
        ...
        <div class="container">
            ...
            <div class="row gx-0">
                <div class="col-12 col-lg-6 p-0">
                    <a href="#" class="custom-box">
                        <img src="../../public/img/sanbongda.png" alt="" class="img-fluid">
                        <p>Sân bóng đá</p>
                    </a>
                </div>
                <div class="col-12 col-lg-6 p-0">
                    <a href="#" class="custom-box">
                        <img src="../../public/img/sancaulong.png" alt="" class="img-fluid">
                        <p>Sân cầu lông</p>
                    </a>
                </div>
            </div>
            <div class="row row gx-0">
                <div class="col-6 col-lg-4 p-0">
                    <a href="#" class="custom-box">
                        <img src="../../public/img/santenis.png" alt="" class="img-fluid">
                        <p>Sân tennis</p>
                    </a>
                </div>
                <div class="col-6 col-lg-4 p-0">
                    <a href="#" class="custom-box">
                        <img src="../../public/img/sanbongchuyen.png" alt="" class="img-fluid">
                        <p>Sân bóng chuyền</p>
                    </a>
                </div>
                <div class="col-6 col-lg-4 p-0">
                    <a href="#" class="custom-box">
                        <img src="../../public/img/sanpickkleball.png" alt="" class="img-fluid">
                        <p>Sân pickkleball</p>
                    </a>
                </div>
            </div>
    ...
    <section class="popular-y mx-lg-auto mx-2">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center mb-2 px-2">
                ...
                <RouterLink to="/sanpham" class="seemore">
                    <div>Xem thêm</div>
                    <i class="bi bi-caret-right-fill"></i>
                </RouterLink>
            </div>
            ...
            <div class="row justify-content-between">
                    ...
                    <div class="yard-infor-map px-5 px-lg-2">
                        <div class="timeplay d-flex justify-content-between align-items-center">
                            <div class="dateplay" style="width: 49%;">
                                <input class="form-control form-date custom-input-booking py-3" style="color-scheme: dark;" type="date" name="dateplay" id="dateplay">
                            </div>
                            <div class="dateplay" style="width: 49%;">
                                <select name="timeplay" class="form-date custom-input-booking" id="" style="padding: 11px 8px;">
                ...
                <div class="col-lg-3 col-12 p-0">
                    <form class="yard-infor-map px-5 px-lg-2">
                        ...
                        <div class="py-2">
                            <input type="text" class="form-control-lg custom-input-booking" name="name" style="width: 93%;" placeholder="Họ tên">
                        </div>
                        <div class="py-2">
                            <input type="text" class="form-control-lg custom-input-booking" name="phone" style="width: 93%;" placeholder="Số điện thoại">
                        </div>
                        <div class="py-4 d-flex justify-content-end">
                            <button type="submit" class="btn-find" style="width: fit-content; padding: 17px 36px;">Đặt sân</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="row gx-0">
                <div class="col-12 col-lg-8 col-md-8">
                    <div class="newsmean px-3 py-2 px-lg-3">
                        <div class="newafter">
                            <img src="../../public/img/new1.png" alt="" class="img-fluid">
                            <div class="new-content">
                                ...
                                <a href="#" class="btn-booknow">Đọc tiếp</a>
                            </div>
                        </div>
                        ...
                        <div class="rating-user text-center p-3 py-4 my-2">
                            ...
                            <div class="d-flex justify-content-center">
                                <p class="w-75 fs-4" style="color: var(--colortext1); line-height: 2.2rem;">
                                    "Gói combo tiện lợi, tiết kiệm chi phí. Đặt sân dễ dàng, nước uống luôn có sẵn trong tủ lạnh mát lạnh."
                                </p>
                            </div>
                            <div class="d-flex justify-content-center">
                                <div class="d-flex align-items-center gap-2 pt-1 pb-2">
