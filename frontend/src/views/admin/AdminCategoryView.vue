<template>
    <main>
                    ...
                    <table class="category-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="category-name">Áo</td>
                                <td class="category-desc">Áo</td>
                                <td class="category-img">
                                    <img src="../../../public/img/placeholder.png" alt="Áo" class="category-thumbnail">
                                </td>
                                <td>
                                    <div class="status-select-wrapper">
                                        <div class="status-select unavailable" @click="toggleStatus($event)">
                                            <div class="status-border"></div>
                                            <span class="status-text">Ngưng hoạt động</span>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="action-buttons">
                                        <button class="action-btn view-btn" title="Xem"><i class="bi bi-eye-fill"></i></button>
                                        <button class="action-btn edit-btn" title="Sửa"><i class="bi bi-pencil-square"></i></button>
                                        <button class="action-btn delete-btn" title="Xóa"><i class="bi bi-trash-fill"></i></button>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="category-name">Quần</td>
                                <td class="category-desc">Quần</td>
                                <td class="category-img">
                                    <img src="../../../public/img/placeholder.png" alt="Quần" class="category-thumbnail">
                                </td>
                                <td>
                                    <div class="status-select-wrapper">
                                        <div class="status-select unavailable" @click="toggleStatus($event)">
                            ...
                            <tr>
                                ...
                                <td class="category-name">Giày</td>
                                <td class="category-desc">Giày</td>
                                <td class="category-img">
                                    <img src="../../../public/img/placeholder.png" alt="Giày" class="category-thumbnail">
                                </td>
                                <td>
                                    <div class="status-select-wrapper">
                                        <div class="status-select unavailable" @click="toggleStatus($event)">
                            ...
                            <tr>
                                ...
                                <td class="category-name">Vợt</td>
                                <td class="category-desc">Vợt</td>
                                <td class="category-img">
                                    <img src="../../../public/img/placeholder.png" alt="Vợt" class="category-thumbnail">
                                </td>
                                <td>
                                    <div class="status-select-wrapper">
                                        <div class="status-select available" @click="toggleStatus($event)">
                                            <div class="status-border"></div>
                            ...
                            <tr class="highlight-row">
                                ...
                                <td class="category-name">Gậy golf</td>
                                <td class="category-desc">Gậy golf</td>
                                <td class="category-img">
                                    <img src="../../../public/img/placeholder.png" alt="Gậy golf" class="category-thumbnail">
                                </td>
                                <td>
                                    <div class="status-select-wrapper">
                                        <div class="status-select available" @click="toggleStatus($event)">
                            ...
                            <tr>
                                ...
                                <td class="category-name">Mũ</td>
                                <td class="category-desc">Mũ</td>
                                <td class="category-img">
                                    <img src="../../../public/img/placeholder.png" alt="Mũ" class="category-thumbnail">
                                </td>
                                <td>
                                    <div class="status-select-wrapper">
                                        <div class="status-select available" @click="toggleStatus($event)">
        ...
        <!-- Modal thêm danh mục -->
        <div class="modal-backdrop" v-if="showAddCategoryModal" @click="closeAddCategoryModal"></div>
                ...
                <div class="modal-body">
                    <form @submit.prevent="addNewCategory" class="add-category-form">
                        ...
                        <div class="form-row action-row">
                            <button type="button" class="btn btn-cancel" @click="closeAddCategoryModal">Hủy</button>
...
// Thêm hàm toggle trạng thái khi click vào ô
function toggleStatus(event) {
    ...
    if (statusSelect.classList.contains('available')) {
        // Nếu đang là "Đang sử dụng" thì chuyển thành "Đang cập nhật"
        statusSelect.classList.remove('available');
        statusSelect.classList.add('updating');
        statusText.textContent = 'Đang cập nhật';
        console.log('Đã chuyển sang: Đang cập nhật');
    } else if (statusSelect.classList.contains('updating')) {
        // Nếu đang là "Đang cập nhật" thì chuyển thành "Ngưng sử dụng"
        statusSelect.classList.remove('updating');
        statusSelect.classList.add('unavailable');
        statusText.textContent = 'Ngưng sử dụng';
        console.log('Đã chuyển sang: Ngưng sử dụng');
    } else {
        // Nếu đang là "Ngưng sử dụng" thì chuyển thành "Đang sử dụng"
        statusSelect.classList.remove('unavailable');
        statusSelect.classList.add('available');
        statusText.textContent = 'Đang sử dụng';
        console.log('Đã chuyển sang: Đang sử dụng');
    }
}
